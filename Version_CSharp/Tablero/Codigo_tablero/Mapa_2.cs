...
{ 
	...
	private Vector2[] posicionInicio = {
		new Vector2(1, 23), new Vector2(24, 1), new Vector2(1, -20), new Vector2(-22, 1)
	};

	private Vector2 posicionGanar = new Vector2(1, 1);
	...
	public override void _Ready()
	{
		...
		boton.Connect("pressed", this, nameof(OnDiceButtonPressed));
	}
	...
	private Node2D GetPiezaJugador(int jugador)
	{
		switch (jugador)
		{
			case 1: return GetNode<Node2D>("J1P1"); // Referencia a la pieza del jugador 1 (puedes cambiar esto según los nombres de tus piezas)
			case 2: return GetNode<Node2D>("J2P1"); // Referencia a la pieza del jugador 2
			case 3: return GetNode<Node2D>("J3P1"); // Referencia a la pieza del jugador 3
			case 4: return GetNode<Node2D>("J4P1"); // Referencia a la pieza del jugador 4
			default: return GetNode<Node2D>("J1P1");
		}
	}
